...
<body style="overflow-y: auto; overflow-x: hidden;padding: 0px; background-color: #fafafa">
	...
	action="${ctx }/security/dust/createReport.action">
		<fieldset class="x-fieldset">
			...
			<table style="width: 375px" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					data-options="editable:false,required:true,panelHeight:140,panelWidth:210" id="reportStationId">
				...
				<tr>
					...
					<td width="295px">
						...
						value="<fmt:formatDate value='${reportHeader.reportStartDate }' pattern='yyyy-MM-01 00:00:00'/>" 
						onclick="WdatePicker({maxDate:'#F{$dp.$D(\'reportDate\')}',dateFmt:'yyyy-MM-01 00:00:00',errDealMode:2,autoUpdateOnChanged:true})">
					</td>
				</tr>
				<!-- 
				<tr>
				...
				<tr>
					...
					<td width="295px">
						...
						class="x-form-text easyui-validatebox Wdate" 
						value="<fmt:formatDate value='${reportHeader.reportDate }' pattern='yyyy-MM-01 00:00:00'/>" 
						onclick="WdatePicker({minDate:'#F{$dp.$D(\'reportStartDate\')}',dateFmt:'yyyy-MM-01 00:00:00',errDealMode:2,autoUpdateOnChanged:true})">
					</td>
				</tr>
				<tr height="30px">
