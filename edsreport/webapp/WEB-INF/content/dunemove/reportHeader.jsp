...
<body style="overflow-y: auto; overflow-x: hidden;padding: 0px; background-color: #fafafa">
	...
	action="${ctx }/security/dunemove/createReport.action">
		<fieldset class="x-fieldset">
			...
			<table style="width: 375px" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					data-options="editable:false,required:true,panelHeight:120,panelWidth:210" id="reportStationId">
				...
				<tr>
					...
					<td width="295px">
						...
						data-options="required:true,panelHeight:80" id="reporterName">
				...
				<tr height="30px">
					...
					<td>
						...
						value="<fmt:formatDate value='${reportHeader.reportStartDate }' pattern='yyyy-MM-08'/>" 
				...
				<tr height="30px">
					...
					<td>
						...
						class="x-form-text easyui-validatebox Wdate" 
						value="<fmt:formatDate value='${reportHeader.reportDate }' pattern='yyyy-MM-08'/>" 
						onclick="WdatePicker({dateFmt:'yyyy-MM-21',minDate:'#F{$dp.$D(\'reportStartDate\')}',maxDate:'%y-06-21',errDealMode:2,autoUpdateOnChanged:true})">
					</td>
				</tr>
				<tr height="30px">
