...
<body style="overflow-y: auto; overflow-x: hidden;padding: 0px; background-color: #fafafa">
	...
	action="${ctx }/security/cropgrowth/createReport.action">
		<fieldset class="x-fieldset">
			...
			<table style="width: 375px" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					data-options="editable:false,required:true,panelHeight:180,panelWidth:210" id="reportStationId">
				...
				<tr>
					...
					<td width="295px">
						<textarea name="reportRemarks" class="x-form-text easyui-validatebox"  style="height: 50px"></textarea>
					</td>
				</tr>
			</table>
		</fieldset>
