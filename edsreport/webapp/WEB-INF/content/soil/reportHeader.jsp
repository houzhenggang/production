...
<body style="overflow-y: auto; overflow-x: hidden;padding: 0px; background-color: #fafafa">
	...
	action="${ctx }/security/soil/createReport.action">
			...
			<table style="width: 375px" border="0" cellpadding="0" cellspacing="0">
				...
				<tr height="30px">
					...
					<td width="295px">
						...
						onclick="WdatePicker({maxDate:'#F{$dp.$D(\'reportDate\')}',dateFmt:'yyyy-MM-01',errDealMode:2,autoUpdateOnChanged:true})">
					</td>
				</tr>
				<tr height="30px">
					...
					<td width="295px">
						...
						onclick="WdatePicker({minDate:'#F{$dp.$D(\'reportStartDate\')}',dateFmt:'yyyy-MM-01',errDealMode:2,autoUpdateOnChanged:true})">
					</td>
				</tr>
				<tr height="30px">
