...
},beforePageText:"当前第 ",afterPageText:" 页/共 {pages}页",displayMsg:"显示记录 {from} - {to} /共 {total} 条记录"};
})(jQuery);
(function($){
function _92(_93){
var _94=$(_93);
...
confirms:function(_21a,msg,fn,fn1){
var _21b="<div class=\"messager-icon messager-question\"></div>"+"<div>"+msg+"</div>"+"<div style=\"clear:both;\"/>";
var _21c={};
_21c[$.messager.defaults.add]=function(){
win.window("close");
if(fn1){
fn1(true);
return false;
...
$.messager.defaults={ok:"Ok",cancel:"Cancel",add:"继续添加"};
})(jQuery);
(function($){
function _224(_225){
...
if(opts.validType){
	var _b_validTypes = (opts.validType).replace().replace(/\s+/g,"").split(",");
	for(var _iii=0;_iii<_b_validTypes.length;_iii++){
	    var vType = _b_validTypes[_iii];
		var _384=/([a-zA-Z_]+)(.*)/.exec(vType);
...
$.fn.validatebox.defaults={required:false,validType:null,missingMessage:"必须输入值.",invalidMessage:null,rules:{email:{validator:function(_38b){
...
},message:"请输入合法的邮箱."},url:{validator:function(_38c){
...
},message:"输入值必须大于 {0} 小于 {1}."},remote:{validator:function(_38f,_390){
var data={};
data[_390[1]]=_38f;
...
$.fn.calendar.defaults={width:180,height:180,fit:false,border:true,firstDay:0,weeks:["天","一","二","三","四","五","六"],months:["一月","二月","三月","四月","五月","六月","七月","八月","九月","十月","十一月","十二月"],year:new Date().getFullYear(),month:new Date().getMonth()+1,current:new Date(),onSelect:function(date){
}};
})(jQuery);
(function($){
function init(_3e9){
...
_792(this,q);
}},currentText:"今天",closeText:"取消",okText:"确定",formatter:function(date){
